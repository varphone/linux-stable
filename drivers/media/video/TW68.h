...
#define TW68_VERSION_CODE KERNEL_VERSION(2, 0, 1)
...
struct TW68_dev {
	...
	unsigned int  dwRegPB;  // liutest add current register PB flag
	unsigned int  dwRegST;  // liutest add intrrupt state
	struct tasklet_struct      bf_tasklet;             /* performs  buffer copy  interrupt work         */
	struct tasklet_struct      resync_tasklet;             /* performs video resync interrupt work         */
