 ...
 */
static __maybe_unused const struct regval sc2210_hdr2_10_1920x1080_45fps_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
/*
 * Xclk 27Mhz linear 12bit 256*1024 60fps 432Mbps/lane
 */
static const struct regval sc2210_linear_12_256x1024_60fps_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
/*
 * Xclk 27Mhz linear 12bit 1920*544 116fps 432Mbps/lane
 */
static const struct regval sc2210_linear_12_1920x544_116fps_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
/*
 * Xclk 27Mhz linear 12bit 1920*768 83.6fps 432Mbps/lane
 */
static const struct regval sc2210_linear_12_1920x768_83_6fps_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
/*
 * Xclk 27Mhz linear 12bit 1920*1080 60fps 432Mbps/lane
 */
...
/*
 * Xclk 27Mhz hdr2 12bit 1920*1080 30fps 432Mbps/lane
 */
...
static const struct sc2210_mode modes_mixed_formats[] = {
	{
		/* linear modes */
		.bus_fmt = MEDIA_BUS_FMT_SBGGR12_1X12,
		.width = 1920,
...
sc2210_find_best_fit(struct sc2210 *sc2210, struct v4l2_subdev_format *fmt)
{
	...
	for (i = 0; i < sc2210->cfg_num; i++) {
		dist = sc2210_get_reso_dist(&mg->modes[i], framefmt);
