...
/*
 * Xclk 27Mhz linear 1920*1080 60fps 432Mbps/lane
 */
static const struct regval sc2210_linear12bit_1920x1080_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
 ...
 */
static __maybe_unused const struct regval sc2210_hdr10bit_1920x1080_regs[] = {
	//{0x0103, 0x01},
	{0x303f, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0xa6},
...
static const struct sc2210_mode supported_modes[] = {
	{
		...
		.hts_def = 0x044c * 2,
		.vts_def = 0x0465,
		.reg_list = sc2210_linear12bit_1920x1080_regs,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 1,
		.bpp = 12,
	...
	},
	{
		...
		.reg_list = sc2210_hdr10bit_1920x1080_regs,
		.hdr_mode = HDR_X2,
		.mipi_freq_idx = 1,
		.bpp = 10,
...
static void sc2210_change_mode(struct sc2210 *sc2210, const struct sc2210_mode *mode)
{
	...
	dev_info(&sc2210->client->dev, "set fmt: cur_mode: %dx%d, hdr: %d\n",
