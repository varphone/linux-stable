...
/*
 * Xclk 24Mhz linear 10bit 1920*480 200fps 594Mbps/lane
 */
static const struct regval sc2210_linear_10_1920x480_200fps_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
static const struct sc2210_mode supported_modes[] = {
	{
		...
		.vts_def = 0x021c, // REG{0x320e,0x320f}
		.reg_list = sc2210_linear_10_1920x480_200fps_regs,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 1,
		.bpp = 10,
