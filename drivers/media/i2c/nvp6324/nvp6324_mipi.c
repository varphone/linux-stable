...
void nvp6324_mipi_init(struct nvp6324 *self)
{
	...
	memcpy(&reg_pack, &nvp6324_mipi_clk_data[self->phy_mclks].reg_pack, sizeof(reg_pack));

	nvp6324_transfer_regs(self, &reg_pack, 0, 1);
...
void nvp6324_mipi_fmt_set(struct nvp6324 *self)
{
	...
	nvp6324_transfer_regs(self, &fmt->reg_pack, 0, 1);
}
