...
static int hibvt_rtc_init(struct hibvt_rtc *rtc)
{
    ...
    || defined(CONFIG_ARCH_HI3556V200) || defined(CONFIG_ARCH_HI3559V200)\
    || defined(CONFIG_ARCH_HI3516CV500) || defined(CONFIG_ARCH_HI3516DV300)
	ret |= hibvt_spi_rtc_write(spi_reg, RTC_REG_LOCK4, 0x0);
	ret |= hibvt_spi_rtc_write(spi_reg, RTC_REG_LOCK3, 0x0);
	ret |= hibvt_spi_rtc_write(spi_reg, RTC_REG_LOCK2, 0x0);
	ret |= hibvt_spi_rtc_write(spi_reg, RTC_REG_LOCK1, 0x0);
#endif
    /* default FREQ COEF */
