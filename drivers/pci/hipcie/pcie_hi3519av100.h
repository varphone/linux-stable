...
#define MISC_CTRL_BASE		0x04528000	/*MISC*/
#define PCIE_MEM_BASE		0x18000000	/*mem空间*/
#define PCIE_EP_CONF_BASE	0x10000000	/*配置空间*/
#define PCIE_DBI_BASE		0x0EFF0000	/*寄存器空间,MISC?*/
