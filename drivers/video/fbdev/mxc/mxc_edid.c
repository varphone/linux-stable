...
const struct fb_videomode mxc_cea_mode[64] = {
	...
	/* #31: 1920x1080p@59Hz */
	[31] = {
		NULL, 59, 1920, 1080, 6734, 88, 192, 41, 4, 44, 5,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED | FB_VMODE_ASPECT_16_9, 0,
	},
	...
	/* #48: 1920x720p@60Hz 16:6 */
	[48] = {
		NULL, 60, 1920, 720, 10556, 80, 48, 6, 23, 32, 10,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED, 0
	},
	/* #49: 1536x576p@50Hz 16:6 */
	[49] = {
		NULL, 50, 1536, 576, 17477, 192, 40, 7, 3, 152, 10,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED, 0
	},
	/* #50: 1536x576p@60Hz 16:6 */
	[50] = {
		NULL, 60, 1536, 576, 14254, 208, 56, 10, 3, 152, 10,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED, 0
	},
	/* #51: 1440x544p@60Hz 16:6 */
	[51] = {
		NULL, 60, 1440, 544, 18502, 80, 48, 6, 3, 32, 10,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED, 0
	},
	/* #52: 1376x512p@60Hz 16:6 */
	[52] = {
		NULL, 60, 1376, 512, 20434, 80, 48, 6, 3, 32, 10,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED, 0
	},
};
