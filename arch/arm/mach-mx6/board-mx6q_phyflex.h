...
#define PHYFLEX_IPU2_PAD_CTRL (PAD_CTL_PUS_100K_DOWN) //by lwx 

#define PHYFLEX_PAD_EIM_DA9__CSI1_0   \
	(_MX6Q_PAD_EIM_DA9__IPU2_CSI1_D_0 | MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx

#define PHYFLEX_PAD_EIM_DA9__CSI1_1   \
	(_MX6Q_PAD_EIM_DA8__IPU2_CSI1_D_1 | MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx


#define PHYFLEX_PAD_EIM_DA7__CSI1_2   \
	(_MX6Q_PAD_EIM_DA7__IPU2_CSI1_D_2 | MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx

#define PHYFLEX_PAD_EIM_DA6__CSI1_3   \
	(_MX6Q_PAD_EIM_DA6__IPU2_CSI1_D_3 | MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx

#define PHYFLEX_PAD_EIM_EB1__IPU2_CSI1_D_10 \
	(_MX6Q_PAD_EIM_EB1__IPU2_CSI1_D_10 |  MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx

#define PHYFLEX_PAD_EIM_EB0__IPU2_CSI1_D_11 \
	(_MX6Q_PAD_EIM_EB0__IPU2_CSI1_D_11 | MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx

#define PHYFLEX_PAD_GPIO_1__GPIO_1_1 \
    (_MX6Q_PAD_GPIO_1__GPIO_1_1 | MUX_PAD_CTRL(PHYFLEX_IPU2_PAD_CTRL))  //by lwx

#define PHYFLEX_PAD_EIM_DA10__GPIO_3_10 \
    (_MX6Q_PAD_EIM_DA10__GPIO_3_10 | MUX_PAD_CTRL(PAD_CTL_PUS_100K_UP))  //by lwx


#define PHYFLEX_PAD_EIM_EB1__IPU2_CSI1_D_10_HIGH \
	(_MX6Q_PAD_EIM_EB1__IPU2_CSI1_D_10 |  MUX_PAD_CTRL(PAD_CTL_PUS_100K_UP))  //by lwx

#define PHYFLEX_PAD_EIM_EB0__IPU2_CSI1_D_11_HIGH \
	(_MX6Q_PAD_EIM_EB0__IPU2_CSI1_D_11 | MUX_PAD_CTRL(PAD_CTL_PUS_100K_UP))  //by lwx
...
static iomux_v3_cfg_t mx6q_phytec_common_pads[] = {
	...
	/* GPIOS */
	MX6Q_PAD_DISP0_DAT14__GPIO_5_8, /* Interrupt for LCD017 */
	...
	MX6Q_PAD_GPIO_17__GPIO_7_12, /* Interrupt for LCD018 */
...
//	MX6Q_PAD_NANDF_CS3__ESAI1_TX1,
	...
	/* USBOTG ID pin */
//	MX6Q_PAD_GPIO_1__USBOTG_ID, // by lwx
...
//	MX6Q_PAD_CSI0_DATA_EN__GPIO_5_20, //by lwx
	PHYFLEX_PAD_GPIO_5__CCM_CLKO,	// conflict with interrupt ts 1 soc1362.0
	MX6Q_PAD_ENET_RX_ER__GPIO_1_24,
//	MX6Q_PAD_CSI0_DAT10__IPU1_CSI0_D_10,  //by lwx
//	MX6Q_PAD_CSI0_DAT11__IPU1_CSI0_D_11,   //by lwx
	...
	// bt.656 mode is [DATA12 - DATA19]
//	MX6Q_PAD_EIM_DA10__GPIO_3_10,        
//	MX6Q_PAD_EIM_DA10__IPU2_CSI1_DATA_EN,  //by lwx
//	MX6Q_PAD_EIM_DA9__IPU2_CSI1_D_0, //by lwx
//	MX6Q_PAD_EIM_DA8__IPU2_CSI1_D_1, //by lwx
...
//	MX6Q_PAD_EIM_EB1__IPU2_CSI1_D_10, //by lwx
//	MX6Q_PAD_EIM_EB0__GPIO_2_28,       //by lwx 
//	MX6Q_PAD_EIM_EB0__IPU2_CSI1_D_11,  // CHANGE BY LWX
	...
	//////////////////////////////////////// by lwx set DATA0 DATA1 DATA10 DATA11 to zero by pull down 100K
	PHYFLEX_PAD_EIM_DA9__CSI1_0,
	PHYFLEX_PAD_EIM_DA9__CSI1_1,
//	PHYFLEX_PAD_EIM_DA7__CSI1_2,   // gate mode
//	PHYFLEX_PAD_EIM_DA6__CSI1_3,   // gate mode
	PHYFLEX_PAD_EIM_EB1__IPU2_CSI1_D_10, // BT1120
	PHYFLEX_PAD_EIM_EB0__IPU2_CSI1_D_11, // BT1120
    PHYFLEX_PAD_GPIO_1__GPIO_1_1,   // pull down usb id
//	PHYFLEX_PAD_EIM_DA10__GPIO_3_10,  //Pull up CSI1 de_video
	/////////////////////////////////////// end lwx
