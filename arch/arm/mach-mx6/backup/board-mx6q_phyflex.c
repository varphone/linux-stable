...
#define MX6_PHYFLEX_POWER_OFF	    IMX_GPIO_NR(5, 8)
#define MX6_PHYFLEX_TLVAIC31_RST    IMX_GPIO_NR(5, 7)
...
//	mxc_iomux_set_gpr_register(1, 19, 2, 1);
	mxc_iomux_set_gpr_register(1, 19, 2, 3);  //设置csi0 和 csi1为并口模式
}
