...
static void __init myimx6ek314_fixup(struct machine_desc *desc, struct tag *tags,
 ...
 */
static void __init myimx6ek314_board_init(void)
{
	int i;
	int ret;
...
static void __init myimx6ek314_timer_init(void)
{
	struct clk *uart_clk;
...
static struct sys_timer myimx6ek314_timer = {
	.init   = myimx6ek314_timer_init,
};

static void __init myimx6ek314_reserve(void)
{
	phys_addr_t phys;
...
MACHINE_START(MYIMX6EK314, "MYZR i.MX6 Evaluation Kit ( MXM 314 )")
	...
	.fixup = myimx6ek314_fixup,
	.map_io = mx6_map_io,
	.init_irq = mx6_init_irq,
	.init_machine = myimx6ek314_board_init,
	.timer = &myimx6ek314_timer,
	.reserve = myimx6ek314_reserve,
MACHINE_END
